...
$api4_url="https://opendata.cwb.gov.tw/api/v1/rest/datastore/C-B0025-001?Authorization=CWB-E7799364-6F85-44B7-BF07-F8C9C143E0B8";
...
$cate=array();
$defaultname="請選擇";
$title = array('天氣狀況', '降雨率', '溫度c', '舒適度','溫度(2)c');
if(isset($_POST['number'])){
    ...
    $defaultname=$current[$id]->locationName;
...
<form method="post" action="test.php"> 
    ...
    <?php $i=0; foreach($current as  $value){ $i++?>
    <option value=<?=$i?>><?=$value->locationName;?></option>
    <?php }?>
    </select>
