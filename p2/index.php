...
//觀光資訊資料庫
//$api6_url="https://quality.data.gov.tw/dq_download_json.php?nid=7778&md5_url=b9db64173d6dfe503a7ef03d9e4c4010";
...
$json_string = file_get_contents('url6.json');  

var_dump($json_string["XML_Head"]["Infos"]);
